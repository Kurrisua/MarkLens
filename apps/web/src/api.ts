...
export const api = {
  ...
  createDocument: (analysisId: string) => request<AgentRun>("/api/v1/app/documents", { method: "POST", headers: aiSession.headers(), body: JSON.stringify({ analysis_id: analysisId, document_type: "trademark_registration_risk_report" }) }),
